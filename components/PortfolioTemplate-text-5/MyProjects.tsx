...
const PROJECTS: Project[] = [
  {
    ...
    description:
      'A high-performance bidding web platform. Features live state syncing using WebSockets, concurrent bid queue handling, and cached auction tracking for millisecond responsiveness.',
    tech: ['Next.js', 'Node.js', 'Redis', 'Docker', 'WebSockets'],
    src: '/assets/pic 1.svg',
    repoUrl: 'https://github.com/Abdullah786346',
    liveUrl: 'https://real-time-auction-system-front.vercel.app/',
  },
  {
    id: 'project-2',
    title: 'Heal Me – Donation App',
    description:
      'Crowdfunding platform allowing patients and contributors to list, explore, and fund healthcare campaigns. Integrated with real-time donation progress bars and verification flows.',
    ...
    liveUrl: 'https://webiste-for-donation.vercel.app/',
  },
  {
    id: 'project-3',
    title: 'Poultry Science Platform',
    description:
      'A comprehensive academic and operational portal providing responsive resource directories, diagnosis logs, and educational guides for poultry health management.',
    tech: ['Next.js', 'Tailwind CSS', 'Redux', 'API Integration'],
    src: '/assets/pic 3.svg',
    repoUrl: 'https://github.com/Abdullah786346',
    liveUrl: 'https://poultryscienceorg-com.vercel.app/',
  },
];
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map((t, idx) => (
                    <span
                      key={idx}
                      className="px-2.5 py-0.5 text-xs font-semibold text-gray-300 bg-white/5 rounded-md border border-white/5 group-hover:border-[#01eeff]/10 group-hover:text-[#01eeff] transition-colors"
                    >
                      {t}
                    </span>
                  ))}
